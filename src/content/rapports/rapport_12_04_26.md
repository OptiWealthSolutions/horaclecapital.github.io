...
<figure>
<img src="../assets/img/US_CPI_APRIL.png" alt="Graphique Macro : Inflation vs Real Activity" />
<figcaption>Fig 1.1 - US Macro: Inflation vs Real Activity (Source: FRED / Horacle Capital)</figcaption>
</figure>
...
- **Nouvelle-Zélande (NZD) :** La RBNZ a maintenu le taux officiel de liquidité (OCR) à 5,50 %, conservant un ton restrictif malgré le ralentissement de la consommation.
- **Suisse (CHF) :** Les réserves de change de la BNS ont chuté de 15 milliards de CHF en mars, indiquant des interventions pour soutenir la monnaie nationale.
